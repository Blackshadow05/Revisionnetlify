...
export default function EvidenceUploader({
  ...
  return (
    <div className="space-y-3">
      <label className="form-label bg-transparent md:bg-black/40 text-gray-900 md:text-white px-3 py-1 rounded-lg shadow-sm border border-gray-200 md:border-none inline-flex items-center gap-2">
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 font-medium rounded-lg transition-all duration-200 ${
                disabled
                  ? 'bg-gray-400 md:bg-gray-500 text-gray-600 md:text-gray-300 cursor-not-allowed opacity-50 border border-gray-300 md:border-none'
                  : 'bg-[#d4b06c] md:bg-[#c9a45c] hover:bg-[#e0c07a] md:hover:bg-[#d4b06c] text-[#1a1f35] shadow-lg md:shadow-[6px_6px_12px_rgba(0,0,0,0.3),-6px_-6px_12px_rgba(255,255,255,0.1),inset_2px_2px_4px_rgba(255,255,255,0.2),inset_-2px_-2px_4px_rgba(0,0,0,0.1)] hover:shadow-xl md:hover:shadow-[8px_8px_16px_rgba(0,0,0,0.35),-8px_-8px_16px_rgba(255,255,255,0.15),inset_3px_3px_6px_rgba(255,255,255,0.25),inset_-3px_-3px_6px_rgba(0,0,0,0.15)] transform hover:scale-[1.02] border-2 md:border border-[#d4b06c] md:border-[#d4b06c]'
              }`}
            >
            ...
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 font-medium rounded-lg transition-all duration-200 ${
                disabled
                  ? 'bg-gray-400 md:bg-gray-500 text-gray-600 md:text-gray-300 cursor-not-allowed opacity-50 border border-gray-300 md:border-none'
                  : 'bg-gray-300 md:bg-[#2a3347] hover:bg-gray-400 md:hover:bg-[#3d4659] text-gray-900 md:text-white shadow-lg md:shadow-[6px_6px_12px_rgba(0,0,0,0.4),-6px_-6px_12px_rgba(255,255,255,0.05),inset_2px_2px_4px_rgba(255,255,255,0.1),inset_-2px_-2px_4px_rgba(0,0,0,0.2)] hover:shadow-xl md:hover:shadow-[8px_8px_16px_rgba(0,0,0,0.45),-8px_-8px_16px_rgba(255,255,255,0.08),inset_3px_3px_6px_rgba(255,255,255,0.15),inset_-3px_-3px_6px_rgba(0,0,0,0.25)] transform hover:scale-[1.02] border-2 md:border border-gray-400 md:border-[#3d4659]'
              }`}
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {imageUrl && (
        <div className="relative mt-3">
          ...
          <div className="mt-2 text-xs text-gray-500 md:text-gray-400 flex items-center gap-1">
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
